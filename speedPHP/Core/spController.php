<?php
	...
	class spController {
		...
		public function display($tplname, $output = TRUE) {
			@ob_start();
			if($GLOBALS['G_SP']['view']['enabled'] == TRUE) {
		...
		public function auto_display($tplname) {
			if($this -> v -> displayed != TRUE && $GLOBALS['G_SP']['view']['auto_display'] != FALSE) {
				if(method_exists($this -> v -> engine, 'templateExists') && $this -> v -> engine -> templateExists($tplname) == TRUE)
